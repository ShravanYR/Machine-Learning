...
main = tkinter.Tk()
main.title("Machine Learning Approach for Fraud Detection in Blockchain") #designing main screen
...
title = Label(main, text='MACHINE LEARNING APPROACH FOR FRAUD DETECTION IN BLOCKCHAIN')
title.config(bg='#3D71B0', fg='white')
title.config(font=font)
title.config(height=3, width=117)
title.place(x=50,y=5)

font1 = ('times', 12, 'bold')
text=Text(main,height=20,width=175)
